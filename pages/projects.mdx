...
less time-to-insight. Based on the existing examples of FCC analyses, COFFEA examples of the same are to be built and documented, which
 ...
 __Links__:
 1. [Project Proposal](https://research-software-collaborations.org/trainees/PrayagYadav.html)
 2. [coffea-fcc-analyses Repository](https://github.com/prayagyadav/coffea-fcc-analyses)
 3. [coffea-fcc-analyses Documentation](https://coffea-fcc-analyses.readthedocs.io/en/latest/)
 4. [FCC Workshop Talk Slides](https://indico.cern.ch/event/1439509/contributions/6289559/attachments/2995158/5276761/FCC_Workshop_Presentation.pdf)
